            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">
                        <a href="{{ route('panel.setting.create')  }}" class="btn btn-primary">Yeni Ekle</a>
                    </p>
                                    ...
                                    <tr class="item" item-id="{{ $setting->id }}">
                                        ...
                                        <td class="d-flex">
                                            <a class="btn btn-primary mr-2"
                                               href="{{ route('panel.setting.edit', $setting->id) }}">Düzenle</a>
...
@section('customjs')
    <script>
        ...
        $(document).on('click', '.sil-btn', function (e) {
            ...
            alertify.confirm("Silmek istediğinizden emin misiniz?", "Silinen setting bir daha erişilemez.",
                function () {
                    $.ajax({
                        headers: {
